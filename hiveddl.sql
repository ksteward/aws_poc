...
LOAD DATA LOCAL INPATH 's3://kls-omniture/inputdata/users.tsv.gz'
...
LOAD DATA LOCAL INPATH 's3://kls-omniture/inputdata/products.tsv.gz'
...
LOAD DATA INPATH 's3://kls-omniture/inputdata/Omniture.0.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3://kls-omniture/inputdata/Omniture.1.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3://kls-omniture/inputdata/Omniture.2.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3://kls-omniture/inputdata/Omniture.3.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
