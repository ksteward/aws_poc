...
LOCATION "/tmp/users";
LOAD DATA INPATH 's3n://kls-omniture/inputdata/users.tsv.gz'
...
LOAD DATA INPATH 's3n://kls-omniture/inputdata/products.tsv.gz'
...
LOAD DATA INPATH 's3n://kls-omniture/inputdata/Omniture.0.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3n://kls-omniture/inputdata/Omniture.1.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3n://kls-omniture/inputdata/Omniture.2.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3n://kls-omniture/inputdata/Omniture.3.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3n://kls-omniture/inputdata/Omniture.4.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
LOAD DATA INPATH 's3n://kls-omniture/inputdata/Omniture.5.tsv.gz'
OVERWRITE INTO TABLE omniturelogs;
...
LOCATION 's3n://kls-omniture/outputdata/';
